...
main: main.o Node.o Operator.o Leaf.o Operation.o Tree.o Generation.o
	g++ main.o Node.o Operator.o Leaf.o Operation.o Tree.o Generation.o -o  main

main.o: main.cpp Node.h Operator.h Leaf.h Operation.h Tree.h Generation.h
